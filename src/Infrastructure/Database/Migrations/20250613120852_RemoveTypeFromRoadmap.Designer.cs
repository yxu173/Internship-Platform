...
namespace Infrastructure.Database.Migrations
{
    ...
    [Migration("20250613120852_RemoveTypeFromRoadmap")]
    partial class RemoveTypeFromRoadmap
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Aggregates.Resumes.GeneratedResume", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Aggregates.Roadmaps.Quiz", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Aggregates.Roadmaps.QuizAttempt", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Aggregates.Roadmaps.QuizOption", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Aggregates.Roadmaps.QuizQuestion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Aggregates.Roadmaps.Enrollment", b =>
                {
                    ...
                    b.OwnsMany("Domain.Aggregates.Roadmaps.SectionProgress", "SectionProgress", b1 =>
                        {
                            ...
                            b1.Property<bool>("QuizPassed")
                                .HasColumnType("boolean");

                            b1.HasKey("SectionId", "EnrollmentId");

                            b1.HasIndex("EnrollmentId");

                            b1.ToTable("SectionProgress", (string)null);
            ...
            modelBuilder.Entity("Domain.Aggregates.Roadmaps.Quiz", b =>
                {
                    b.HasOne("Domain.Aggregates.Roadmaps.RoadmapSection", "Section")
                        .WithOne("Quiz")
                        .HasForeignKey("Domain.Aggregates.Roadmaps.Quiz", "SectionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Aggregates.Roadmaps.QuizAttempt", b =>
                {
                    b.HasOne("Domain.Aggregates.Roadmaps.Enrollment", null)
                        .WithMany("QuizAttempts")
                        .HasForeignKey("EnrollmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsMany("Domain.Aggregates.Roadmaps.QuizAnswer", "Answers", b1 =>
                        {
                            ...
                            b1.ToTable("QuizAnswers", (string)null);
            ...
            modelBuilder.Entity("Domain.Aggregates.Roadmaps.QuizOption", b =>
                {
                    b.HasOne("Domain.Aggregates.Roadmaps.QuizQuestion", null)
                        .WithMany("Options")
            ...
            modelBuilder.Entity("Domain.Aggregates.Roadmaps.QuizQuestion", b =>
                {
                    b.HasOne("Domain.Aggregates.Roadmaps.Quiz", null)
                        .WithMany("Questions")
