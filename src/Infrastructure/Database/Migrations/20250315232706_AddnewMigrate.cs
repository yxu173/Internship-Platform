...
{
    /// <inheritdoc />
    public partial class AddnewMigrate : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ResourceLink", x => new { x.RoadmapItemId, x.Id });
                    table.ForeignKey(
                        name: "FK_ResourceLink_RoadmapItems_RoadmapItemId",
